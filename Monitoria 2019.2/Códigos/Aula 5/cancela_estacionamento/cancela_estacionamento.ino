...
#define SS_PIN 10
#define RST_PIN 9
// Definicoes pino modulo RC522MFRC522 
    ...
    if ( ! mfrc522.PICC_IsNewCardPresent())   {   
      ...
      if ( ! mfrc522.PICC_ReadCardSerial())   {    
        ...
        for (byte i = 0; i < mfrc522.uid.size; i++)   {    
          ...
          Serial.println();  Serial.print("Mensagem : "); 
          conteudo.toUpperCase();   
          // Testa se o cartao1 foi lido
          if (conteudo.substring(1) == "DB 16 D7 00")  {  
            ...
            if (conteudo.substring(1) == "89 3F 8C 5A")  {   
